...
alter procedure RefinancibleUniverse_FunctionOfRates_Loan (@rate double, @asofdate Date) 
as
begin
...
select 
       refinanceible1 = sum(case when l.OrigNoteRate 
					...
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance1 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end),
       refinanceible2 = sum(case when l.OrigNoteRate 
					+ (case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end) 
					- (@rate-0.4) 
					- (case when l.calcorigmonth_LL <= 200906 then (case when tl.totalLLPA > 0.75 then 0.75 else tl.totalLLPA end) else tl.totalLLPA end)/4 
					- (case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= 0.5 
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance2 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end),
       refinanceible3 = sum(case when l.OrigNoteRate 
					+ (case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end) 
					- (@rate-0.3) 
					- (case when l.calcorigmonth_LL <= 200906 then (case when tl.totalLLPA > 0.75 then 0.75 else tl.totalLLPA end) else tl.totalLLPA end)/4 
					- (case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= 0.5 
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance3 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end),
       refinanceible4 = sum(case when l.OrigNoteRate 
					+ (case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end) 
					- (@rate-0.2) 
					- (case when l.calcorigmonth_LL <= 200906 then (case when tl.totalLLPA > 0.75 then 0.75 else tl.totalLLPA end) else tl.totalLLPA end)/4 
					- (case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= 0.5 
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance4 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end),
       refinanceible5 = sum(case when l.OrigNoteRate 
					+ (case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end) 
					- (@rate-0.1) 
					- (case when l.calcorigmonth_LL <= 200906 then (case when tl.totalLLPA > 0.75 then 0.75 else tl.totalLLPA end) else tl.totalLLPA end)/4 
					- (case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= 0.5 
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance5 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end),
       refinanceible6 = sum(case when l.OrigNoteRate 
					+ (case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end) 
					- @rate
					- (case when l.calcorigmonth_LL <= 200906 then (case when tl.totalLLPA > 0.75 then 0.75 else tl.totalLLPA end) else tl.totalLLPA end)/4 
					- (case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= 0.5 
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance6 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end),
       refinanceible7 = sum(case when l.OrigNoteRate 
					+ (case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end) 
					- (@rate+0.1) 
					- (case when l.calcorigmonth_LL <= 200906 then (case when tl.totalLLPA > 0.75 then 0.75 else tl.totalLLPA end) else tl.totalLLPA end)/4 
					- (case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= 0.5 
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance7 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end),
       refinanceible8 = sum(case when l.OrigNoteRate 
					+ (case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end) 
					- (@rate+0.2) 
					- (case when l.calcorigmonth_LL <= 200906 then (case when tl.totalLLPA > 0.75 then 0.75 else tl.totalLLPA end) else tl.totalLLPA end)/4 
					- (case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= 0.5 
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance8 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end),
       refinanceible9 = sum(case when l.OrigNoteRate 
					+ (case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end) 
					- (@rate+0.3)
					- (case when l.calcorigmonth_LL <= 200906 then (case when tl.totalLLPA > 0.75 then 0.75 else tl.totalLLPA end) else tl.totalLLPA end)/4 
					- (case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= 0.5 
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance9 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end),
       refinanceible10 = sum(case when l.OrigNoteRate 
					+ (case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end) 
					- (@rate+0.4)
					- (case when l.calcorigmonth_LL <= 200906 then (case when tl.totalLLPA > 0.75 then 0.75 else tl.totalLLPA end) else tl.totalLLPA end)/4 
					- (case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= 0.5 
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance10 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end),
       refinanceible11 = sum(case when l.OrigNoteRate 
					+ (case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end) 
					- (@rate+0.5) 
					- (case when l.calcorigmonth_LL <= 200906 then (case when tl.totalLLPA > 0.75 then 0.75 else tl.totalLLPA end) else tl.totalLLPA end)/4 
					- (case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= 0.5 
					then (case when lh.currentRpb > 0 then lh.currentRpb  + pre.ITMBalance11 else 0.000001 end) else 0 end)
				/sum(case when lh.currentRpb > 0 then lh.currentRpb + pre.currBalance else 0.000001 end)
...
exec RefinancibleUniverse_FunctionOfRates_Loan 3.98, '20150601'
