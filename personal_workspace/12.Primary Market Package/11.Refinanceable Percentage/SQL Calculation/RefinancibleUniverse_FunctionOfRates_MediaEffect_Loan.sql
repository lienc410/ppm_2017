------------------------------------------------------------------------
------------------procedure for the loan level model with Media Effect - As function of rates
------------------------------------------------------------------------

alter procedure RefinancibleUniverse_FunctionOfRates_MediaEffect_Loan(@rate double, @asof Date, @thisweek date) 
as
begin
  ----------------------------------------------------
  ...
  select asOfDate,
    AsOfMonth=convert(date,DateAdd(month,1,convert(date,year(asOfDate) || '-' || month(asOfDate) || '-01'))),
  ...
  select StartDate=m1.asOfdate,EndDate=m2.asofdate,StartMonth=m1.AsOfMonth,EndMonth=m2.AsOfMonth,
    NumberOfWeeks1=convert(numeric(10,5),null),
    NumberOfWeeks2=convert(numeric(10,5),null),
    NumberOfWeeks3=convert(numeric(10,5),null),
    NumberOfWeeks4=convert(numeric(10,5),null),
    NumberOfWeeks5=convert(numeric(10,5),null),
    NumberOfWeeks6=convert(numeric(10,5),null),
    NumberOfWeeks7=convert(numeric(10,5),null),
    NumberOfWeeks8=convert(numeric(10,5),null),
    NumberOfWeeks9=convert(numeric(10,5),null),
    NumberOfWeeks10=convert(numeric(10,5),null),
    NumberOfWeeks11=convert(numeric(10,5),null)
    into #NumberOfWeeks
  ...
  update #NumberOfWeeks as r
    set NumberOfWeeks1 = t.NumberOfWeeks1,
    NumberOfWeeks2 = t.NumberOfWeeks2,
    NumberOfWeeks3 = t.NumberOfWeeks3,
    NumberOfWeeks4 = t.NumberOfWeeks4,
    NumberOfWeeks5 = t.NumberOfWeeks5,
    NumberOfWeeks6 = t.NumberOfWeeks6,
    NumberOfWeeks7 = t.NumberOfWeeks7,
    NumberOfWeeks8 = t.NumberOfWeeks8,
    NumberOfWeeks9 = t.NumberOfWeeks9,
    NumberOfWeeks10 = t.NumberOfWeeks10,
    NumberOfWeeks11 = t.NumberOfWeeks11 from
    (select r.StartDate,r.EndDate,
      NumberOfWeeks1=sum(case when m.SeriesNumValue <= (@rate-.5) then 1 else 0 end),
      NumberOfWeeks2=sum(case when m.SeriesNumValue <= (@rate-.4) then 1 else 0 end),
      NumberOfWeeks3=sum(case when m.SeriesNumValue <= (@rate-.3) then 1 else 0 end),
      NumberOfWeeks4=sum(case when m.SeriesNumValue <= (@rate-.2) then 1 else 0 end),
      NumberOfWeeks5=sum(case when m.SeriesNumValue <= (@rate-.1) then 1 else 0 end),
      NumberOfWeeks6=sum(case when m.SeriesNumValue <= @rate then 1 else 0 end),
      NumberOfWeeks7=sum(case when m.SeriesNumValue <= (@rate+.1) then 1 else 0 end),
      NumberOfWeeks8=sum(case when m.SeriesNumValue <= (@rate+.2) then 1 else 0 end),
      NumberOfWeeks9=sum(case when m.SeriesNumValue <= (@rate+.3) then 1 else 0 end),
      NumberOfWeeks10=sum(case when m.SeriesNumValue <= (@rate+.4) then 1 else 0 end),
      NumberOfWeeks11=sum(case when m.SeriesNumValue <= (@rate+.5) then 1 else 0 end)
...
COMMIT
  ...
  select refinanceible1=sum(case when r.NumberOfWeeks1 <= 12 then(case when l.OrigNoteRate
      ...
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance1 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end),
    refinanceible2=sum(case when r.NumberOfWeeks2 <= 12 then(case when l.OrigNoteRate
      +(case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end)
      -(@rate-.4)
      -(case when l.calcorigmonth_LL <= 200906 then(case when tl.totalLLPA > .75 then .75 else tl.totalLLPA end) else tl.totalLLPA end)/4
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance2 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end),
    refinanceible3=sum(case when r.NumberOfWeeks3 <= 12 then(case when l.OrigNoteRate
      +(case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end)
      -(@rate-.3)
      -(case when l.calcorigmonth_LL <= 200906 then(case when tl.totalLLPA > .75 then .75 else tl.totalLLPA end) else tl.totalLLPA end)/4
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance3 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end),
    refinanceible4=sum(case when r.NumberOfWeeks4 <= 12 then(case when l.OrigNoteRate
      +(case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end)
      -(@rate-.2)
      -(case when l.calcorigmonth_LL <= 200906 then(case when tl.totalLLPA > .75 then .75 else tl.totalLLPA end) else tl.totalLLPA end)/4
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance4 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end),
    refinanceible5=sum(case when r.NumberOfWeeks5 <= 12 then(case when l.OrigNoteRate
      +(case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end)
      -(@rate-.1)
      -(case when l.calcorigmonth_LL <= 200906 then(case when tl.totalLLPA > .75 then .75 else tl.totalLLPA end) else tl.totalLLPA end)/4
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance5 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end),
    refinanceible6=sum(case when r.NumberOfWeeks6 <= 12 then(case when l.OrigNoteRate
      +(case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end)
      -@rate
      -(case when l.calcorigmonth_LL <= 200906 then(case when tl.totalLLPA > .75 then .75 else tl.totalLLPA end) else tl.totalLLPA end)/4
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance6 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end),
    refinanceible7=sum(case when r.NumberOfWeeks7 <= 12 then(case when l.OrigNoteRate
      +(case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end)
      -(@rate+.1)
      -(case when l.calcorigmonth_LL <= 200906 then(case when tl.totalLLPA > .75 then .75 else tl.totalLLPA end) else tl.totalLLPA end)/4
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance7 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end),
    refinanceible8=sum(case when r.NumberOfWeeks8 <= 12 then(case when l.OrigNoteRate
      +(case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end)
      -(@rate+.2)
      -(case when l.calcorigmonth_LL <= 200906 then(case when tl.totalLLPA > .75 then .75 else tl.totalLLPA end) else tl.totalLLPA end)/4
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance8 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end),
    refinanceible9=sum(case when r.NumberOfWeeks9 <= 12 then(case when l.OrigNoteRate
      +(case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end)
      -(@rate+.3)
      -(case when l.calcorigmonth_LL <= 200906 then(case when tl.totalLLPA > .75 then .75 else tl.totalLLPA end) else tl.totalLLPA end)/4
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance9 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end),
    refinanceible10=sum(case when r.NumberOfWeeks10 <= 12 then(case when l.OrigNoteRate
      +(case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end)
      -(@rate+.4)
      -(case when l.calcorigmonth_LL <= 200906 then(case when tl.totalLLPA > .75 then .75 else tl.totalLLPA end) else tl.totalLLPA end)/4
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance10 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end),
    refinanceible11=sum(case when r.NumberOfWeeks11 <= 12 then(case when l.OrigNoteRate
      +(case when l.PctMtgIns > 0 then tcp.PMI/100 else 0 end)
      -(@rate+.5)
      -(case when l.calcorigmonth_LL <= 200906 then(case when tl.totalLLPA > .75 then .75 else tl.totalLLPA end) else tl.totalLLPA end)/4
      -(case when l.calcorigmonth_LL <= 200906 then 0 else tp.PMI/100 end) >= .5 then
        (case when lh.currentRpb > 0 then lh.currentRpb+pre.ITMBalance11 else .000001 end) else 0 end)
    else 0
    end)/sum(case when lh.currentRpb > 0 then lh.currentRpb+pre.currBalance else .000001 end)
...
exec RefinancibleUniverse_FunctionOfRates_MediaEffect_Loan 3.98, '2015-06-01', '2015-07-02'