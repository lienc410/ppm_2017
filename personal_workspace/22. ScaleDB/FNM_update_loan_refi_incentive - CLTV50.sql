...
CAST('2018-08-01' AS DATE) asOf_last,
...
delete from #FNM_LoanIncentive where MtgRate is NULL;
...
UPDATE #FNM_LoanIncentive inc 
SET conv_incentive = CASE WHEN inc.marketTicker = 'FNCT' THEN origNoteRate + (origPMI / 100.0) - MtgRate - (llpa / 3.5) - pmi
                                ELSE origNoteRate + (origPMI / 100.0) - MtgRate - (llpa / 4.0) - pmi END;
DELETE from #FNM_LoanIncentive where conv_incentive is NULL;

UPDATE #FNM_LoanIncentive inc 
SET conv_incentive_fc = CASE WHEN inc.marketTicker = 'FNCT' THEN origNoteRate + (origPMI / 100.0) - MtgRate - (llpa / 3.5) - pmi - fixed_cost
...
UPDATE #FNM_LoanIncentive inc 
SET conv_incentive_cltv50 = CASE WHEN inc.marketTicker = 'FNCT' THEN origNoteRate + (origPMI / 100.0) - MtgRate - (llpa_cltv50 / 3.5) - pmi_cltv50
...
UPDATE #FNM_LoanIncentive inc 
SET conv_incentive_fc_cltv50 = CASE WHEN inc.marketTicker = 'FNCT' THEN origNoteRate + (origPMI / 100.0) - MtgRate - (llpa_cltv50 / 3.5) - pmi_cltv50 - fixed_cost
...
UPDATE #FNM_LoanIncentive inc SET fha_incentive_fc = origNoteRate + (origPMI / 100.0) - MtgRate_GNMA - mip - fixed_cost;
UPDATE #FNM_LoanIncentive inc SET fha_incentive_fc = 0 WHERE fha_incentive_fc is NULL;

-- Update FHA Refinance Incentive CLTV50
UPDATE #FNM_LoanIncentive inc SET fha_incentive_cltv50 = origNoteRate + (origPMI / 100.0) - MtgRate_GNMA - mip_cltv50;
UPDATE #FNM_LoanIncentive inc SET fha_incentive_cltv50 = 0 WHERE fha_incentive_cltv50 is NULL;

UPDATE #FNM_LoanIncentive inc SET fha_incentive_fc_cltv50 = origNoteRate + (origPMI / 100.0) - MtgRate_GNMA - mip_cltv50 - fixed_cost;
...
UPDATE #FNM_LoanIncentive inc SET fha_incentive_cltv50 = NULL WHERE inc.marketTicker in ('FNCI', 'FNCT');
UPDATE #FNM_LoanIncentive inc SET fha_incentive_fc_cltv50 = NULL WHERE inc.marketTicker in ('FNCI', 'FNCT');
