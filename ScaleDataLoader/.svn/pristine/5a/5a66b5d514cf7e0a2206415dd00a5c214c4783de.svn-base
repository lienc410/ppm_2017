...
--SELECT CAST ('2013-01-01' AS DATE) asOf INTO #tmp_asOf
;
...
-- G2SF-JM
DROP TABLE IF EXISTS #GNM_LoanBurnout_G2SF_JM;
SELECT
    sl.marketTicker, 
    t0.loanSeqNum,
    t0.asOf as asOf,
...
INSERT INTO #GNM_LoanBurnout (marketTicker, loanSeqNum, asOf, burnout)
SELECT * FROM #GNM_LoanBurnout_G2SF_JM;
DROP TABLE IF EXISTS #GNM_LoanBurnout_G2SF_JM;
