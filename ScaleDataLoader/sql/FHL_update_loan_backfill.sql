...
join fhl.PIV_loan cl on mh.loanseqnum = cl.loanseqnum
where l.version in (select originationVersion from #tmp_version);
commit;
...
FROM #fha_eligibility e, fhl.PIV_Loan cl
