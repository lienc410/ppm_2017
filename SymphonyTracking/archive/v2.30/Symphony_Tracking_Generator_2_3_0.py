...
def main(argv):
    ...
    global scale_path
    scale_path = 'S:\\IT\\Production\\ScaleMQ\\release\\4.68\\'
    #scale_path = 'S:\\IT\\Dev\\ScaleMQ\\release_symphony_tracking\\'

    global r_baton_path
    #r_baton_path = 'C:\\PIV\\PIV-it-dev\\trunk\\Research\\AgencyPrepayment\\Baton\\'
    r_baton_path = 'S:\\IT\\Dev\\AgencyPrepayment\\v2.30\\Baton\\'

    global r_tieout_file
    r_tieout_file = "conventional_model\\v2.30\\GenSymphonyTracking.R"
