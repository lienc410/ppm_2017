...
def generate_pool_data(full_update, model, factor_date, sample_only):
    ...
    def process(ticker):
        ...
        symphony_tracking_path = 'S:/IT/Production/Scripts/python/Scale/SymphonyTracking/v' + model + '/'
    ...
    for ticker in ticker_list:
        ...
        for file_name in file_list:
            ...
            if use_r_engine:
                ...
                r_script = os.path.join(r_baton_path, r_tieout_file)
...
def load_model_data(model, factor_date, full_update):
    ...
    update_file = os.path.join(sql_path, "updatePoolPrepay_DEV.sql")
    if not (full_update):
...
def main(argv):
    ...
    global scale_path
    scale_path = 'S:\\IT\\Production\\ScaleMQ\\release\\4.69\\'
    #scale_path = 'S:\\IT\\Dev\\ScaleMQ\\release_symphony_tracking\\'

    global r_baton_path
    #r_baton_path = 'C:\\PIV\\PIV-it-dev\\trunk\\Research\\AgencyPrepayment\\Baton\\'
    r_baton_path = 'S:\\IT\\Dev\\AgencyPrepayment\\v2.40\\batonutil\\'
