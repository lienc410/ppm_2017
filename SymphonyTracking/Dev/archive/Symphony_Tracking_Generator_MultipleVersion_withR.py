        ...
        for loan_type in loan_type_list:
            ...
            for file_name in file_list:
                if file_name.find(loan_type) >= 0:
                    ...
                    if use_r_engine:
                        os.chdir(r_path)
                        r_tieout_file = "GenSymphonyTracking_GNM.R"
                        r_script = os.path.join(r_path, r_tieout_file)
...
def load_model_data_loan(run_ticker_list, factor_date, full_update, model):
    ...
    for run_ticker in run_ticker_list:
        ...
        #full_update_SQLStmt = "delete " + tableName + "  where modelId = '" + model_version + "'  and issueId in (select issueId from (select issueId,agency from fnm.Sec UNION ALL select issueId,agency from fhl.Sec UNION ALL select issueId,agency from gnm.Sec ) t where agency = '"+agency+"')"
        full_update_SQLStmt_2 = "delete " + tableName + "  where modelId = '90' and issueId in (select issueId from (select issueId,agency from fnm.Sec UNION ALL select issueId,agency from fhl.Sec UNION ALL select issueId,agency from gnm.Sec ) t where agency = '"+agency+"')"
		...
		# Update the loaded data in Tracking table with modelId
        updateSQLStmt = "update " + tableName + "  set modelId = '90' where modelId is NULL"
        print updateSQLStmt
        cursor.execute(updateSQLStmt)
...
def main(argv):
    ...
    split_threads = 25
    split_file_size = 700    # megabytes

    global scale_threads
    scale_threads = 20 # adjust based on how much CPU you want to allocate to Scale (1 = lowest, 32 = highest)
    ...
    model_scale_path = {'4.10': {'baton_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.40\\Scale_v2.02',
                           'gnmandolin_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.40\\Scale_v2.02',
                           'glockenspiel_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.40\\Scale_v2.02'},
                   '4.20': {'baton_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.50_dev\\Scale_v2.02',
                           'gnmandolin_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.50_dev\\Scale_v2.02',
                           'glockenspiel_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.50_dev\\Scale_v2.02'},
                   '4.30': {'baton_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\Scale_v2.02',
                           'gnmandolin_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\Scale_v2.02',
                           'glockenspiel_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\\Scale_v2.02'},
                   '4.31': {'baton_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\Scale_v2.02',
                           'gnmandolin_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\Scale_v2.02',
                           'glockenspiel_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\\Scale_v2.02'},
                   '9.97': {'baton_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\\Scale_v2.02',
                           'gnmandolin_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\\Scale_v2.02',
                           'glockenspiel_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\\Scale_v2.02'},
                   '9.98': {'baton_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\\Scale_v2.02',
                           'gnmandolin_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\\Scale_v2.02',
                           'glockenspiel_model_scale_path': 'S:\\IT\\Production\\ScaleMQ\\release\\5.54_dev\\\Scale_v2.02'}
                   }
    global model_dict # To store  executable for a model
    model_dict = {'4.10': {'baton_model_name': 'Baton_v4.10',
                   ...
                   '4.20': {'baton_model_name': 'Baton_v4.30',
                           'baton_model_version': '4.31',
                           'gnmandolin_model_name': 'Gnmandolin_v4.30',
                           'gnmandolin_model_version': '4.30',
                           'glockenspiel_model_name': 'Glockenspiel_v2.00',
                           'glockenspiel_model_version': '2.00'},
                   '4.30': {'baton_model_name': 'Baton_v4.30',
                           'baton_model_version': '4.30',
                           'gnmandolin_model_name': 'Gnmandolin_v4.30',
                           'gnmandolin_model_version': '4.30',
                           'glockenspiel_model_name': 'Glockenspiel_v2.00',
                           'glockenspiel_model_version': '2.00'},
                   '4.31': {'baton_model_name': 'Baton_v4.31',
                           'baton_model_version': '4.31',
                           'gnmandolin_model_name': 'Gnmandolin_v4.30',
                           'gnmandolin_model_version': '4.30',
                           'glockenspiel_model_name': 'Glockenspiel_v2.00',
                           'glockenspiel_model_version': '2.00'},                           
                   '9.97': {'baton_model_name': 'Baton_v4.10',
                           'baton_model_version': '9.97',
                           'gnmandolin_model_name': 'Gnmandolin_v4.00',
                           'gnmandolin_model_version': '4.00',
                           'glockenspiel_model_name': 'Glockenspiel_v2.00',
                           'glockenspiel_model_version': '2.00'},
                   '9.98': {'baton_model_name': 'Baton_v4.20',
    ...
    ticker_dict = {'ginnie': {'model':'gnmandolin_model',
                   ...
                   'fannie': {'model':'baton_model',
                              ...
                              'vintage_list': [1950, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, latest_year]},
