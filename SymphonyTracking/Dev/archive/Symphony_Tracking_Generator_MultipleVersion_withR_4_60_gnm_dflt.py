    ...
    for ticker in run_ticker_list:
        ...
        for file_name in file_list:
            ...
            if use_r_engine:
                ...
                r_tieout_file = "GenSymphonyTracking_GNM_4_61_interpolation_dflt.R"
...
def main(argv):
    ...
    scale_threads = 14 # adjust based on how much CPU you want to allocate to Scale (1 = lowest, 32 = highest)
