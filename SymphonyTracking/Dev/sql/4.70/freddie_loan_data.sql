...
WHERE 1=1
	AND sfl.version = (SELECT originationVersion_LL FROM scale.ModelVersionConfig WHERE appType = '4.70' AND agency = 'FHL' and tickerName = 'FGCI')
    AND sli.version = (SELECT IncentiveVersion_LL FROM scale.ModelVersionConfig WHERE appType = '4.70' AND agency = 'FHL' and tickerName = 'FGCI')
    AND slb.version = (SELECT burnoutVersion_LL FROM scale.ModelVersionConfig WHERE appType = '4.70' AND agency = 'FHL' and tickerName = 'FGCI')
    @ASOF_WHERE@
