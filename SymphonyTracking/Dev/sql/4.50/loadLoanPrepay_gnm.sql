...
DELETE FROM #Loading WHERE smmCurtail>=1 or smmDefault>=1 or smmTurnover>=1 or smmCashout>=1 or smmRefinance>=1 or smmCreditCuring>=1 or smmTotal>=1;
COMMIT;
...
cast ((smmCurtail+smmTurnover+smmCashout+smmRefinance+smmCreditCuring) as numeric(9,8)) as SMM_CRR,
