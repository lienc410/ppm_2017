...
WHERE 1=1
	AND sfl.version = (SELECT originationVersion_LL FROM scale.ModelVersionConfig WHERE appType = '4.60' AND agency = 'FHL' and tickerName = 'FGLMC')
    AND sli.version = (SELECT IncentiveVersion_LL FROM scale.ModelVersionConfig WHERE appType = '4.60' AND agency = 'FHL' and tickerName = 'FGLMC')
    AND slb.version = (SELECT burnoutVersion_LL FROM scale.ModelVersionConfig WHERE appType = '4.60' AND agency = 'FHL' and tickerName = 'FGLMC')
    @ASOF_WHERE@
