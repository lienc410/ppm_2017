...
JOIN #HPA_MA hpi
    ...
    --@SAMPLE_JOIN@
WHERE 1=1
    AND sl.version = (SELECT IncentiveVersion_LL FROM scale.ModelVersionConfig WHERE appType = '3.00' AND agency = 'GNM' and tickerName = 'G2SF')
    AND sli.version = (SELECT IncentiveVersion_LL FROM scale.ModelVersionConfig WHERE appType = '3.00' AND agency = 'GNM' and tickerName = 'G2SF')
    AND slb.version = (SELECT BurnoutVersion_LL FROM scale.ModelVersionConfig WHERE appType = '3.00' AND agency = 'GNM' and tickerName = 'G2SF')
