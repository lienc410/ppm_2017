...
WHERE 1=1
    ...
    AND sli.version = (SELECT IncentiveVersion_LL FROM scale.ModelVersionConfig WHERE appType = '4.60' AND agency = 'GNM' and tickerName = 'G2SF')
    ...
    AND cl.reperformingStatus = 'OTHER'
    @ASOF_WHERE@
;
COMMIT;
