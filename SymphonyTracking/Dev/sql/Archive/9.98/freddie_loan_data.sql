...
INTO #SATO_RATE
FROM scale.fhl_loan_dev sfl
WHERE sfl.version = (SELECT originationVersion_LL FROM scale.ModelVersionConfig WHERE appType = '@DATABASE@' AND agency = 'FHL' and tickerName = 'FGLMC')
