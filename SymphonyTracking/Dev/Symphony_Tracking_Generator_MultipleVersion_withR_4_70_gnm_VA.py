    ...
    for ticker in run_ticker_list:
        ...
        for file_name in file_list:
            ...
            if use_r_engine:
                ...
                r_tieout_file = "GenSymphonyTracking_GNM_4_70_interpolation_VA.R"
...
def main(argv):
    ...
    scale_threads = 6 # adjust based on how much CPU you want to allocate to Scale (1 = lowest, 32 = highest)
    ...
    model_dict = {
                   ...
                   '4.62': {'baton_model_name': 'Baton_v4.60',
                           ...
                           'glockenspiel_model_name': 'Glockenspiel_v2.00',
                           'glockenspiel_model_version': '2.00'}, 
                   '4.70': {'baton_model_name': 'Baton_v4.60',
                           'baton_model_version': '4.60',
