...
names(ppdata)   <- c("loanseqnum","asOf","monthBucket","loanType","bal","incentive","refinance_incentive","burnout","wala","wacls","acls","cltv","fico","hasFICOFlag",
                     "hpaAnnual","hpaCum","pct_broker","pct_corres","pct_retail","pct_na","cai","mediaEffect","pct_purchase","wam","oltv","day_count","pct_NY","pct_refi_co",
                     "pct_refi_nco", "pct_hmod","pct_nhmod","pct_rp","pct_none","monthsSinceIssued","pct_TX","pct_PR","pct_grandfather","delq_flag","monthsSince",
...
#1 fta submodel
pre_list_fta  <- c("tangibleBenefitInterp") 
...
ppdata$tangibleBenefitInterp       <- ppdata$prepayMonth
...
ppdata$tangibleBenefit_interp         <-   preparation_fta.df$tangibleBenefitInterp


#2 tover submodel
pre_list_turnover  <- c("hpaInterp", "aclsInterp") 
...
ppdata$hpaInterp        <- ppdata$hpaAnnual
ppdata$aclsInterp       <- ppdata$acls

for (p in preparation_tover) {
  if(!(p %in% names(ppdata))) {
    preparation_tover.df[, p] <- 1.0
    cat("ATTENTION!Missing hpa or acls interpolation in INPUT!", " missing: ", p, "\n")
  }
  else {
...
ppdata$hpa_interpolation             <-   preparation_tover.df$hpaInterp
ppdata$hpa_interpolation_int         <-   floor(preparation_tover.df$hpaInterp)
ppdata$hpa_interpolation_dec         <-   ppdata$hpa_interpolation - ppdata$hpa_interpolation_int 

ppdata$acls_interpolation             <-   preparation_tover.df$aclsInterp
ppdata$acls_interpolation_int         <-   floor(preparation_tover.df$aclsInterp)
ppdata$acls_interpolation_dec         <-   ppdata$acls_interpolation - ppdata$acls_interpolation_int


#3 cout submodel
pre_list_cashout  <- c("walaInterp", "waclsInterp") 
...
ppdata$walaInterp        <- ppdata$wala
ppdata$waclsInterp       <- ppdata$wacls

for (p in preparation_cashout) {
  if(!(p %in% names(ppdata))) {
    preparation_cout.df[, p] <- 1.0
    cat("ATTENTION!Missing wala or wacls interpolation in INPUT!", " missing: ", p, "\n")
  }
  else {
...
ppdata$wala_interpolation           <-   preparation_cout.df$walaInterp
ppdata$wala_interpolation_int       <- floor(preparation_cout.df$walaInterp)
ppdata$wala_interpolation_dec       <- ppdata$wala_interpolation - ppdata$wala_interpolation_int

ppdata$wacls_interpolation           <-   preparation_cout.df$waclsInterp
ppdata$wacls_interpolation_int       <- floor(preparation_cout.df$waclsInterp)
ppdata$wacls_interpolation_dec       <- ppdata$wacls_interpolation - ppdata$wacls_interpolation_int

#4 refi submodel
pre_list_refinance  <- c("mediaEffect", "burnout") 
...
ppdata$media_effect_interpolation  <- preparation.df$mediaEffect
ppdata$media_effect_interpolation_int  <- floor(preparation.df$mediaEffect)
...
ppdata$purch_incentive_4        <- ppdata$incentive
ppdata$purch_incentive_5        <- ppdata$incentive
...
ppdata$refi_co_incentive_4      <- ppdata$incentive
ppdata$refi_co_incentive_5      <- ppdata$incentive
...
ppdata$refi_nco_incentive_4     <- ppdata$incentive
ppdata$refi_nco_incentive_5     <- ppdata$incentive
ppdata$hmod_incentive_0         <- ppdata$incentive
ppdata$hmod_incentive_1         <- ppdata$incentive
ppdata$hmod_incentive_2         <- ppdata$incentive
ppdata$hmod_incentive_3         <- ppdata$incentive
ppdata$hmod_incentive_4         <- ppdata$incentive
ppdata$hmod_incentive_5         <- ppdata$incentive
ppdata$nhmod_incentive_0        <- ppdata$incentive
ppdata$nhmod_incentive_1        <- ppdata$incentive
ppdata$nhmod_incentive_2        <- ppdata$incentive
ppdata$nhmod_incentive_3        <- ppdata$incentive
ppdata$nhmod_incentive_4        <- ppdata$incentive
ppdata$nhmod_incentive_5        <- ppdata$incentive
ppdata$rp_incentive_0           <- ppdata$incentive
ppdata$rp_incentive_1           <- ppdata$incentive
ppdata$rp_incentive_2           <- ppdata$incentive
ppdata$rp_incentive_3           <- ppdata$incentive
ppdata$rp_incentive_4           <- ppdata$incentive
ppdata$rp_incentive_5           <- ppdata$incentive
...
ppdata$lowFicoAdjustment     <- ppdata$fico
...
ppdata$purch_acls_wala_0                 <- ppdata$wala
ppdata$purch_acls_wala_1                 <- ppdata$wala
ppdata$purch_acls_wala_2                 <- ppdata$wala
ppdata$purch_acls_wala_3                 <- ppdata$wala
ppdata$purch_acls_wala_4                 <- ppdata$wala
ppdata$purch_acls_wala_5                 <- ppdata$wala
ppdata$purch_acls_wala_6                 <- ppdata$wala
ppdata$purch_acls_wala_7                 <- ppdata$wala
ppdata$purch_acls_wala_8                 <- ppdata$wala
ppdata$refi_co_acls_wala_0               <- ppdata$wala
ppdata$refi_co_acls_wala_1               <- ppdata$wala
ppdata$refi_co_acls_wala_2               <- ppdata$wala
ppdata$refi_co_acls_wala_3               <- ppdata$wala
ppdata$refi_co_acls_wala_4               <- ppdata$wala
ppdata$refi_co_acls_wala_5               <- ppdata$wala
ppdata$refi_co_acls_wala_6               <- ppdata$wala
ppdata$refi_co_acls_wala_7               <- ppdata$wala
ppdata$refi_co_acls_wala_8               <- ppdata$wala
ppdata$refi_nco_acls_wala_0              <- ppdata$wala
ppdata$refi_nco_acls_wala_1              <- ppdata$wala
ppdata$refi_nco_acls_wala_2              <- ppdata$wala
ppdata$refi_nco_acls_wala_3              <- ppdata$wala
ppdata$refi_nco_acls_wala_4              <- ppdata$wala
ppdata$refi_nco_acls_wala_5              <- ppdata$wala
ppdata$refi_nco_acls_wala_6              <- ppdata$wala
ppdata$refi_nco_acls_wala_7              <- ppdata$wala
ppdata$refi_nco_acls_wala_8              <- ppdata$wala
ppdata$hmod_acls_wala_0              	 <- ppdata$wala
ppdata$hmod_acls_wala_1               	 <- ppdata$wala
ppdata$hmod_acls_wala_2               	 <- ppdata$wala
ppdata$hmod_acls_wala_3               	 <- ppdata$wala
ppdata$hmod_acls_wala_4               	 <- ppdata$wala
ppdata$hmod_acls_wala_5               	 <- ppdata$wala
ppdata$hmod_acls_wala_6               	 <- ppdata$wala
ppdata$hmod_acls_wala_7               	 <- ppdata$wala
ppdata$hmod_acls_wala_8               	 <- ppdata$wala
ppdata$nhmod_acls_wala_0             	 <- ppdata$wala
ppdata$nhmod_acls_wala_1               	 <- ppdata$wala
ppdata$nhmod_acls_wala_2               	 <- ppdata$wala
ppdata$nhmod_acls_wala_3               	 <- ppdata$wala
ppdata$nhmod_acls_wala_4               	 <- ppdata$wala
ppdata$nhmod_acls_wala_5               	 <- ppdata$wala
ppdata$nhmod_acls_wala_6               	 <- ppdata$wala
ppdata$nhmod_acls_wala_7               	 <- ppdata$wala
ppdata$nhmod_acls_wala_8               	 <- ppdata$wala
ppdata$rp_acls_wala_0                  	 <- ppdata$wala
ppdata$rp_acls_wala_1                  	 <- ppdata$wala
ppdata$rp_acls_wala_2                  	 <- ppdata$wala
ppdata$rp_acls_wala_3                  	 <- ppdata$wala
ppdata$rp_acls_wala_4                  	 <- ppdata$wala
ppdata$rp_acls_wala_5                  	 <- ppdata$wala
ppdata$rp_acls_wala_6                  	 <- ppdata$wala
ppdata$rp_acls_wala_7                  	 <- ppdata$wala
ppdata$rp_acls_wala_8                  	 <- ppdata$wala

ppdata$purch_wacls_wala_0                 <- ppdata$wala
ppdata$purch_wacls_wala_1                 <- ppdata$wala
ppdata$purch_wacls_wala_2                 <- ppdata$wala
ppdata$purch_wacls_wala_3                 <- ppdata$wala
ppdata$purch_wacls_wala_4                 <- ppdata$wala
ppdata$purch_wacls_wala_5                 <- ppdata$wala
ppdata$purch_wacls_wala_6                 <- ppdata$wala
ppdata$purch_wacls_wala_7                 <- ppdata$wala
ppdata$purch_wacls_wala_8                 <- ppdata$wala
ppdata$purch_wacls_wala_9                 <- ppdata$wala
ppdata$refi_co_wacls_wala_0               <- ppdata$wala
ppdata$refi_co_wacls_wala_1               <- ppdata$wala
ppdata$refi_co_wacls_wala_2               <- ppdata$wala
ppdata$refi_co_wacls_wala_3               <- ppdata$wala
ppdata$refi_co_wacls_wala_4               <- ppdata$wala
ppdata$refi_co_wacls_wala_5               <- ppdata$wala
ppdata$refi_co_wacls_wala_6               <- ppdata$wala
ppdata$refi_co_wacls_wala_7               <- ppdata$wala
ppdata$refi_co_wacls_wala_8               <- ppdata$wala
ppdata$refi_co_wacls_wala_9               <- ppdata$wala
ppdata$refi_nco_wacls_wala_0              <- ppdata$wala
ppdata$refi_nco_wacls_wala_1              <- ppdata$wala
ppdata$refi_nco_wacls_wala_2              <- ppdata$wala
ppdata$refi_nco_wacls_wala_3              <- ppdata$wala
ppdata$refi_nco_wacls_wala_4              <- ppdata$wala
ppdata$refi_nco_wacls_wala_5              <- ppdata$wala
ppdata$refi_nco_wacls_wala_6              <- ppdata$wala
ppdata$refi_nco_wacls_wala_7              <- ppdata$wala
ppdata$refi_nco_wacls_wala_8              <- ppdata$wala
ppdata$refi_nco_wacls_wala_9              <- ppdata$wala
ppdata$hmod_wacls_wala_0              	  <- ppdata$wala
ppdata$hmod_wacls_wala_1               	  <- ppdata$wala
ppdata$hmod_wacls_wala_2               	  <- ppdata$wala
ppdata$hmod_wacls_wala_3               	  <- ppdata$wala
ppdata$hmod_wacls_wala_4               	  <- ppdata$wala
ppdata$hmod_wacls_wala_5               	  <- ppdata$wala
ppdata$hmod_wacls_wala_6               	  <- ppdata$wala
ppdata$hmod_wacls_wala_7               	  <- ppdata$wala
ppdata$hmod_wacls_wala_8               	  <- ppdata$wala
ppdata$hmod_wacls_wala_9               	  <- ppdata$wala
ppdata$nhmod_wacls_wala_0             	  <- ppdata$wala
ppdata$nhmod_wacls_wala_1                 <- ppdata$wala
ppdata$nhmod_wacls_wala_2                 <- ppdata$wala
ppdata$nhmod_wacls_wala_3                 <- ppdata$wala
ppdata$nhmod_wacls_wala_4                 <- ppdata$wala
ppdata$nhmod_wacls_wala_5                 <- ppdata$wala
ppdata$nhmod_wacls_wala_6                 <- ppdata$wala
ppdata$nhmod_wacls_wala_7                 <- ppdata$wala
ppdata$nhmod_wacls_wala_8                 <- ppdata$wala
ppdata$nhmod_wacls_wala_9                 <- ppdata$wala
ppdata$rp_wacls_wala_0                    <- ppdata$wala
ppdata$rp_wacls_wala_1                    <- ppdata$wala
ppdata$rp_wacls_wala_2                    <- ppdata$wala
ppdata$rp_wacls_wala_3                    <- ppdata$wala
ppdata$rp_wacls_wala_4                    <- ppdata$wala
ppdata$rp_wacls_wala_5                    <- ppdata$wala
ppdata$rp_wacls_wala_6                    <- ppdata$wala
ppdata$rp_wacls_wala_7                    <- ppdata$wala
ppdata$rp_wacls_wala_8                    <- ppdata$wala
ppdata$rp_wacls_wala_9                    <- ppdata$wala
...
ppdata$reficashout_acls         <- ppdata$acls
ppdata$other_acls               <- ppdata$acls
ppdata$TXreficashout_acls       <- ppdata$acls
ppdata$TXother_acls             <- ppdata$acls
ppdata$NYreficashout_acls       <- ppdata$acls
ppdata$NYother_acls             <- ppdata$acls
ppdata$PRreficashout_acls       <- ppdata$acls
ppdata$PRother_acls             <- ppdata$acls

ppdata$reficashout_wacls         <- ppdata$wacls
ppdata$other_wacls               <- ppdata$wacls
ppdata$TXreficashout_wacls       <- ppdata$wacls
ppdata$TXother_wacls             <- ppdata$wacls
ppdata$NYreficashout_wacls       <- ppdata$wacls
ppdata$NYother_wacls             <- ppdata$wacls
ppdata$PRreficashout_wacls       <- ppdata$wacls
ppdata$PRother_wacls             <- ppdata$wacls

ppdata$aclsGrandfather          <- ppdata$acls
ppdata$waclsGrandfather         <- ppdata$wacls
...
ppdata$purch_wacls          <-  ppdata$wacls
ppdata$refi_co_wacls        <-  ppdata$wacls
ppdata$refi_nco_wacls       <-  ppdata$wacls
ppdata$hmod_wacls           <-  ppdata$wacls
ppdata$nhmod_wacls          <-  ppdata$wacls
ppdata$rp_wacls             <-  ppdata$wacls
...
cat("\n","Calculate Curtailment: Start",  "\n")
ppdata$curt       <- PredictSubmodel_4_70_interpolation_VA(coll=coll, submodel="curt", submdl.spl=curt.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$pred
...
dfltTest = FALSE
if (dfltTest){
  defaultResult       <- PredictDflt(dfltD0.mdl, dfltD30.mdl, dfltD60.mdl, NA, dfltCure.mdl, dfltBuyout.mdl, test = dfltTest, ppdata, kNewModelVersion)
}
if (!dfltTest){
  defaultResult       <- data.frame(PredictDflt(dfltD0.mdl, dfltD30.mdl, dfltD60.mdl, NA, dfltCure.mdl, dfltBuyout.mdl, test = dfltTest, ppdata, kNewModelVersion))
...
cat("\n","Calculate Cashout: Start", "\n")
ppdata$cout                 <- PredictSubmodel_4_70_interpolation_VA(coll=coll, submodel="cout", submdl.spl=cout.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
cat("\n","Calculate Turnover: Start", "\n")
ppdata$incentive            <- ppdata$incentive.store
ppdata$turn                 <- PredictSubmodel_4_70_interpolation_VA(coll=coll, submodel="turn", submdl.spl=turn.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
cat("\n","Calculate Refinance: Start",  "\n")
ppdata$refi                 <- PredictSubmodel_4_70_interpolation_VA(coll=coll, submodel="refi", submdl.spl=refi.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
cat("\n","Calculate Credit Curing: Start",  "\n")
ppdata$credit_curing        <- PredictSubmodel_4_70_interpolation_VA(coll=coll, submodel="cc", submdl.spl=credcur.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
cat("\n","Calculate Fixed To ARM: Start",  "\n")
ppdata$fta            <- PredictSubmodel_4_70_interpolation_VA(coll=coll, submodel="fta", submdl.spl=fta.mdl, data=ppdata, seasadj=FALSE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
# turn_test       <- PredictSubmodel_4_70_interpolation_VA(coll=coll, submodel="turn", submdl.spl=turn.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$mult
# refi_test       <- PredictSubmodel_4_70_interpolation_VA(coll=coll, submodel="refi", submdl.spl=refi.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$mult
# cc_test       <- PredictSubmodel_4_70_interpolation_VA(coll=coll, submodel="cc", submdl.spl=credcur.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$mult
# fta_test       <- PredictSubmodel_4_70_interpolation_VA(coll=coll, submodel="fta", submdl.spl=fta.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$mult
...
#smm.df.csv    <- data.frame(paste(ppdata$loanseqnum, ppdata$asOf, ppdata$curt, ppdata$dfltall, ppdata$turn, ppdata$cout, ppdata$refi, ppdata$credit_curing, ppdata$fta, ppdata$dfltTransit, ppdata$dfltBuyout, ppdata$modelSMM, names(turn_test), turn_test, "",sep = "|"))
...
# dflt test
#smm.df.csv        <- data.frame(cbind(ppdata$loanseqnum, ppdata$asOf))
#names(smm.df.csv) <- c("loanSeqNum", "asOf")
#smm.df.csv        <- data.frame(cbind(smm.df.csv, defaultResult))
#fwrite(smm.df.csv, data.output, row.names = F, col.names = T, qmethod = "escape")
