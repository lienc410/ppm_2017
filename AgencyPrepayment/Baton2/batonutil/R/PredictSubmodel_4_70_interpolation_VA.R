...
PredictSubmodel_4_70_interpolation_VA <- function(coll, submodel = NA, submdl.spl, data, seasadj = FALSE, version = "") {
    ...
    if ((submodel == "refi") & (coll == "conv30")) {
        ...
        if (submodel == "refi") {
            ...
            submdl.pred <- submdl.pred * mult.df[, "hpa_annual"] * mult.df[, "incentive"] * mult.df[, "cltv"] * mult.df[, "fico"] *mult.df[, "tax"] *mult.df[, "pct_second_lien"] * mult.df[, "acls"] * wala.df[, "wala_mult"] *
              ...
              cout_burnout_list  <- c("purch_incentive_0","purch_incentive_1","purch_incentive_2","purch_incentive_3","purch_incentive_4","purch_incentive_5","refi_co_incentive_0","refi_co_incentive_1","refi_co_incentive_2","refi_co_incentive_3","refi_co_incentive_4","refi_co_incentive_5","refi_nco_incentive_0","refi_nco_incentive_1","refi_nco_incentive_2","refi_nco_incentive_3","refi_nco_incentive_4","refi_nco_incentive_5","hmod_incentive_0","hmod_incentive_1","hmod_incentive_2","hmod_incentive_3","hmod_incentive_4","hmod_incentive_5","nhmod_incentive_0","nhmod_incentive_1","nhmod_incentive_2","nhmod_incentive_3","nhmod_incentive_4","nhmod_incentive_5","rp_incentive_0","rp_incentive_1","rp_incentive_2","rp_incentive_3","rp_incentive_4","rp_incentive_5")
			  ...
			  cout_temp1 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"purch_incentive_0"], cout_burnout.df[,"purch_incentive_1"], cout_burnout.df[,"purch_incentive_2"], cout_burnout.df[,"purch_incentive_3"], cout_burnout.df[,"purch_incentive_4"], cout_burnout.df[,"purch_incentive_5"]))  
              
              names(cout_temp1) <- c("wala_interpolation_int","wala_interpolation_dec","purch_incentive_0","purch_incentive_1", "purch_incentive_2", "purch_incentive_3", "purch_incentive_4", "purch_incentive_5")
              
			  cout_temp2 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"refi_co_incentive_0"], cout_burnout.df[,"refi_co_incentive_1"], cout_burnout.df[,"refi_co_incentive_2"], cout_burnout.df[,"refi_co_incentive_3"], cout_burnout.df[,"refi_co_incentive_4"], cout_burnout.df[,"refi_co_incentive_5"]))  
              
              names(cout_temp2) <- c("wala_interpolation_int","wala_interpolation_dec","refi_co_incentive_0","refi_co_incentive_1", "refi_co_incentive_2", "refi_co_incentive_3", "refi_co_incentive_4", "refi_co_incentive_5")
              
			  cout_temp3 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"refi_nco_incentive_0"], cout_burnout.df[,"refi_nco_incentive_1"], cout_burnout.df[,"refi_nco_incentive_2"], cout_burnout.df[,"refi_nco_incentive_3"], cout_burnout.df[,"refi_nco_incentive_4"], cout_burnout.df[,"refi_nco_incentive_5"]))  
              
              names(cout_temp3) <- c("wala_interpolation_int","wala_interpolation_dec","refi_nco_incentive_0","refi_nco_incentive_1", "refi_nco_incentive_2", "refi_nco_incentive_3", "refi_nco_incentive_4", "refi_nco_incentive_5")
              
			  cout_temp4 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"hmod_incentive_0"], cout_burnout.df[,"hmod_incentive_1"], cout_burnout.df[,"hmod_incentive_2"], cout_burnout.df[,"hmod_incentive_3"], cout_burnout.df[,"hmod_incentive_4"], cout_burnout.df[,"hmod_incentive_5"]))  
              
              names(cout_temp4) <- c("wala_interpolation_int","wala_interpolation_dec","hmod_incentive_0","hmod_incentive_1", "hmod_incentive_2", "hmod_incentive_3", "hmod_incentive_4", "hmod_incentive_5")
              
			  cout_temp5 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"nhmod_incentive_0"], cout_burnout.df[,"nhmod_incentive_1"], cout_burnout.df[,"nhmod_incentive_2"], cout_burnout.df[,"nhmod_incentive_3"], cout_burnout.df[,"nhmod_incentive_4"], cout_burnout.df[,"nhmod_incentive_5"]))  
              
              names(cout_temp5) <- c("wala_interpolation_int","wala_interpolation_dec","nhmod_incentive_0","nhmod_incentive_1", "nhmod_incentive_2", "nhmod_incentive_3", "nhmod_incentive_4", "nhmod_incentive_5")
              
			  cout_temp6 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"rp_incentive_0"], cout_burnout.df[,"rp_incentive_1"], cout_burnout.df[,"rp_incentive_2"], cout_burnout.df[,"rp_incentive_3"], cout_burnout.df[,"rp_incentive_4"], cout_burnout.df[,"rp_incentive_5"]))  
              
              names(cout_temp6) <- c("wala_interpolation_int","wala_interpolation_dec","rp_incentive_0","rp_incentive_1", "rp_incentive_2", "rp_incentive_3", "rp_incentive_4", "rp_incentive_5")
