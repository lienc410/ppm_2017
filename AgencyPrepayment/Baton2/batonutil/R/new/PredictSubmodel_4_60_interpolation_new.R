...
PredictSubmodel_4_60_interpolation <- function(coll, submodel = NA, submdl.spl, data, seasadj = FALSE, version = "") {
    ...
    if ((submodel == "refi") & (coll == "conv30")) {
        ...
        if (submodel == "refi") {
            if (coll == "gnma30") {
			  ...
			  burnout_submdl_3  <- burnout_submdl_0
              burnout_submdl_4  <- burnout_submdl_1
              burnout_submdl_5  <- burnout_submdl_2
              
              names(burnout_submdl_0) <- c("first_incentive_GNM_burnout0","first_incentive_GNM_burnout1","first_incentive_GNM_burnout2","first_incentive_GNM_burnout3","first_incentive_GNM_burnout4","first_incentive_GNM_burnout5","first_incentive_GNM_burnout6","first_incentive_GNM_burnout7","first_incentive_GNM_burnout8","first_incentive_GNM_burnout9","first_incentive_GNM_burnout10","first_incentive_GNM_burnout11")
              names(burnout_submdl_1) <- c("second_incentive_GNM_burnout0","second_incentive_GNM_burnout1","second_incentive_GNM_burnout2","second_incentive_GNM_burnout3","second_incentive_GNM_burnout4","second_incentive_GNM_burnout5","second_incentive_GNM_burnout6","second_incentive_GNM_burnout7","second_incentive_GNM_burnout8","second_incentive_GNM_burnout9","second_incentive_GNM_burnout10","second_incentive_GNM_burnout11")
              names(burnout_submdl_2) <- c("third_incentive_GNM_burnout0","third_incentive_GNM_burnout1","third_incentive_GNM_burnout2","third_incentive_GNM_burnout3","third_incentive_GNM_burnout4","third_incentive_GNM_burnout5","third_incentive_GNM_burnout6","third_incentive_GNM_burnout7","third_incentive_GNM_burnout8","third_incentive_GNM_burnout9","third_incentive_GNM_burnout10","third_incentive_GNM_burnout11")
			  names(burnout_submdl_3) <- c("first_incentive_burnout0","first_incentive_burnout1","first_incentive_burnout2","first_incentive_burnout3","first_incentive_burnout4","first_incentive_burnout5","first_incentive_burnout6","first_incentive_burnout7","first_incentive_burnout8","first_incentive_burnout9","first_incentive_burnout10","first_incentive_burnout11")
              names(burnout_submdl_4) <- c("second_incentive_burnout0","second_incentive_burnout1","second_incentive_burnout2","second_incentive_burnout3","second_incentive_burnout4","second_incentive_burnout5","second_incentive_burnout6","second_incentive_burnout7","second_incentive_burnout8","second_incentive_burnout9","second_incentive_burnout10","second_incentive_burnout11")
              names(burnout_submdl_5) <- c("third_incentive_burnout0","third_incentive_burnout1","third_incentive_burnout2","third_incentive_burnout3","third_incentive_burnout4","third_incentive_burnout5","third_incentive_burnout6","third_incentive_burnout7","third_incentive_burnout8","third_incentive_burnout9","third_incentive_burnout10","third_incentive_burnout11")
             
              burnout_list_refinance  <- c("first_incentive_GNM_burnout0","first_incentive_GNM_burnout1","first_incentive_GNM_burnout2","first_incentive_GNM_burnout3","first_incentive_GNM_burnout4","first_incentive_GNM_burnout5","first_incentive_GNM_burnout6","first_incentive_GNM_burnout7","first_incentive_GNM_burnout8","first_incentive_GNM_burnout9","first_incentive_GNM_burnout10","first_incentive_GNM_burnout11","second_incentive_GNM_burnout0","second_incentive_GNM_burnout1","second_incentive_GNM_burnout2","second_incentive_GNM_burnout3","second_incentive_GNM_burnout4","second_incentive_GNM_burnout5","second_incentive_GNM_burnout6","second_incentive_GNM_burnout7","second_incentive_GNM_burnout8","second_incentive_GNM_burnout9","second_incentive_GNM_burnout10","second_incentive_GNM_burnout11","third_incentive_GNM_burnout0","third_incentive_GNM_burnout1","third_incentive_GNM_burnout2","third_incentive_GNM_burnout3","third_incentive_GNM_burnout4","third_incentive_GNM_burnout5","third_incentive_GNM_burnout6","third_incentive_GNM_burnout7","third_incentive_GNM_burnout8","third_incentive_GNM_burnout9","third_incentive_GNM_burnout10","third_incentive_GNM_burnout11","first_incentive_burnout0","first_incentive_burnout1","first_incentive_burnout2","first_incentive_burnout3","first_incentive_burnout4","first_incentive_burnout5","first_incentive_burnout6","first_incentive_burnout7","first_incentive_burnout8","first_incentive_burnout9","first_incentive_burnout10","first_incentive_burnout11","second_incentive_burnout0","second_incentive_burnout1","second_incentive_burnout2","second_incentive_burnout3","second_incentive_burnout4","second_incentive_burnout5","second_incentive_burnout6","second_incentive_burnout7","second_incentive_burnout8","second_incentive_burnout9","second_incentive_burnout10","second_incentive_burnout11","third_incentive_burnout0","third_incentive_burnout1","third_incentive_burnout2","third_incentive_burnout3","third_incentive_burnout4","third_incentive_burnout5","third_incentive_burnout6","third_incentive_burnout7","third_incentive_burnout8","third_incentive_burnout9","third_incentive_burnout10","third_incentive_burnout11")
              ...
              names(burnout.df) <- burnout_list_refinance
                ...
                for (p in names(burnout_submdl_3)) {
                    if(!(p %in% names(ppdata))) {
                        burnout.df[, p] <- 1.0
                        cat("ATTENTION!Missing low media burnout shift in INPUT!", " missing: ", p, "\n")
                    }
                    else {
                        idx <- match(p, names(burnout_submdl_3))
                        a <- unlist(burnout_submdl_3[idx][[1]][1]) 
                        b <- unlist(burnout_submdl_3[idx][[1]][2])
                        x <- ppdata[, p]
                        burnout.df[, p] <- BuildSpline(a = a, b = b, x = x)$y
                    }
                }
                
                for (p in names(burnout_submdl_4)) {
                    if(!(p %in% names(ppdata))) {
                        burnout.df[, p] <- 1.0
                        cat("ATTENTION!Missing mid media burnout shift in INPUT!", " missing: ", p, "\n")
                    }
                    else {
                        idx <- match(p, names(burnout_submdl_4))
                        a <- unlist(burnout_submdl_4[idx][[1]][1]) 
                        b <- unlist(burnout_submdl_4[idx][[1]][2])
                        x <- ppdata[, p]
                        burnout.df[, p] <- BuildSpline(a = a, b = b, x = x)$y
                    }
                }
                
                for (p in names(burnout_submdl_5)) {
                    if(!(p %in% names(ppdata))) {
                        burnout.df[, p] <- 1.0
                        cat("ATTENTION!Missing high media burnout shift in INPUT!", " missing: ", p, "\n")
                    }
                    else {
                        idx <- match(p, names(burnout_submdl_5))
                        a <- unlist(burnout_submdl_5[idx][[1]][1]) 
                        b <- unlist(burnout_submdl_5[idx][[1]][2])
                        x <- ppdata[, p]
                        burnout.df[, p] <- BuildSpline(a = a, b = b, x = x)$y
                    }
                }				
			  ...
			  temp1 <- data.frame(cbind(data[,"burnout_interpolation_int"], data[,"burnout_interpolation_dec"], burnout.df[,"first_incentive_GNM_burnout0"], burnout.df[,"first_incentive_GNM_burnout1"], burnout.df[,"first_incentive_GNM_burnout2"], burnout.df[,"first_incentive_GNM_burnout3"], burnout.df[,"first_incentive_GNM_burnout4"], burnout.df[,"first_incentive_GNM_burnout5"], burnout.df[,"first_incentive_GNM_burnout6"], burnout.df[,"first_incentive_GNM_burnout7"], burnout.df[,"first_incentive_GNM_burnout8"], burnout.df[,"first_incentive_GNM_burnout9"], burnout.df[,"first_incentive_GNM_burnout10"], burnout.df[,"first_incentive_GNM_burnout11"]))  
              
              names(temp1) <- c("burnout_interpolation_int","burnout_interpolation_dec","first_incentive_GNM_burnout0","first_incentive_GNM_burnout1", "first_incentive_GNM_burnout2", "first_incentive_GNM_burnout3", "first_incentive_GNM_burnout4", "first_incentive_GNM_burnout5", "first_incentive_GNM_burnout6", "first_incentive_GNM_burnout7", "first_incentive_GNM_burnout8", "first_incentive_GNM_burnout9", "first_incentive_GNM_burnout10", "first_incentive_GNM_burnout11")
              
              temp2 <- data.frame(cbind(data[,"burnout_interpolation_int"], data[,"burnout_interpolation_dec"], burnout.df[,"second_incentive_GNM_burnout0"], burnout.df[,"second_incentive_GNM_burnout1"], burnout.df[,"second_incentive_GNM_burnout2"], burnout.df[,"second_incentive_GNM_burnout3"], burnout.df[,"second_incentive_GNM_burnout4"], burnout.df[,"second_incentive_GNM_burnout5"], burnout.df[,"second_incentive_GNM_burnout6"], burnout.df[,"second_incentive_GNM_burnout7"], burnout.df[,"second_incentive_GNM_burnout8"], burnout.df[,"second_incentive_GNM_burnout9"], burnout.df[,"second_incentive_GNM_burnout10"], burnout.df[,"second_incentive_GNM_burnout11"]))   
              
              names(temp2) <- c("burnout_interpolation_int","burnout_interpolation_dec","second_incentive_GNM_burnout0","second_incentive_GNM_burnout1", "second_incentive_GNM_burnout2", "second_incentive_GNM_burnout3", "second_incentive_GNM_burnout4", "second_incentive_GNM_burnout5", "second_incentive_GNM_burnout6", "second_incentive_GNM_burnout7", "second_incentive_GNM_burnout8", "second_incentive_GNM_burnout9", "second_incentive_GNM_burnout10", "second_incentive_GNM_burnout11")
              
              temp3 <- data.frame(cbind(data[,"burnout_interpolation_int"], data[,"burnout_interpolation_dec"], burnout.df[,"third_incentive_GNM_burnout0"], burnout.df[,"third_incentive_GNM_burnout1"], burnout.df[,"third_incentive_GNM_burnout2"], burnout.df[,"third_incentive_GNM_burnout3"], burnout.df[,"third_incentive_GNM_burnout4"], burnout.df[,"third_incentive_GNM_burnout5"], burnout.df[,"third_incentive_GNM_burnout6"], burnout.df[,"third_incentive_GNM_burnout7"], burnout.df[,"third_incentive_GNM_burnout8"], burnout.df[,"third_incentive_GNM_burnout9"], burnout.df[,"third_incentive_GNM_burnout10"], burnout.df[,"third_incentive_GNM_burnout11"]))   
              
              names(temp3) <- c("burnout_interpolation_int","burnout_interpolation_dec","third_incentive_GNM_burnout0","third_incentive_GNM_burnout1", "third_incentive_GNM_burnout2", "third_incentive_GNM_burnout3", "third_incentive_GNM_burnout4", "third_incentive_GNM_burnout5", "third_incentive_GNM_burnout6", "third_incentive_GNM_burnout7", "third_incentive_GNM_burnout8", "third_incentive_GNM_burnout9", "third_incentive_GNM_burnout10", "third_incentive_GNM_burnout11")
			  
			  temp4 <- data.frame(cbind(data[,"burnout_interpolation_int"], data[,"burnout_interpolation_dec"], burnout.df[,"first_incentive_burnout0"], burnout.df[,"first_incentive_burnout1"], burnout.df[,"first_incentive_burnout2"], burnout.df[,"first_incentive_burnout3"], burnout.df[,"first_incentive_burnout4"], burnout.df[,"first_incentive_burnout5"], burnout.df[,"first_incentive_burnout6"], burnout.df[,"first_incentive_burnout7"], burnout.df[,"first_incentive_burnout8"], burnout.df[,"first_incentive_burnout9"], burnout.df[,"first_incentive_burnout10"], burnout.df[,"first_incentive_burnout11"]))  
              
              names(temp4) <- c("burnout_interpolation_int","burnout_interpolation_dec","first_incentive_burnout0","first_incentive_burnout1", "first_incentive_burnout2", "first_incentive_burnout3", "first_incentive_burnout4", "first_incentive_burnout5", "first_incentive_burnout6", "first_incentive_burnout7", "first_incentive_burnout8", "first_incentive_burnout9", "first_incentive_burnout10", "first_incentive_burnout11")
              
              temp5 <- data.frame(cbind(data[,"burnout_interpolation_int"], data[,"burnout_interpolation_dec"], burnout.df[,"second_incentive_burnout0"], burnout.df[,"second_incentive_burnout1"], burnout.df[,"second_incentive_burnout2"], burnout.df[,"second_incentive_burnout3"], burnout.df[,"second_incentive_burnout4"], burnout.df[,"second_incentive_burnout5"], burnout.df[,"second_incentive_burnout6"], burnout.df[,"second_incentive_burnout7"], burnout.df[,"second_incentive_burnout8"], burnout.df[,"second_incentive_burnout9"], burnout.df[,"second_incentive_burnout10"], burnout.df[,"second_incentive_burnout11"]))   
              
              names(temp5) <- c("burnout_interpolation_int","burnout_interpolation_dec","second_incentive_burnout0","second_incentive_burnout1", "second_incentive_burnout2", "second_incentive_burnout3", "second_incentive_burnout4", "second_incentive_burnout5", "second_incentive_burnout6", "second_incentive_burnout7", "second_incentive_burnout8", "second_incentive_burnout9", "second_incentive_burnout10", "second_incentive_burnout11")
              
              temp6 <- data.frame(cbind(data[,"burnout_interpolation_int"], data[,"burnout_interpolation_dec"], burnout.df[,"third_incentive_burnout0"], burnout.df[,"third_incentive_burnout1"], burnout.df[,"third_incentive_burnout2"], burnout.df[,"third_incentive_burnout3"], burnout.df[,"third_incentive_burnout4"], burnout.df[,"third_incentive_burnout5"], burnout.df[,"third_incentive_burnout6"], burnout.df[,"third_incentive_burnout7"], burnout.df[,"third_incentive_burnout8"], burnout.df[,"third_incentive_burnout9"], burnout.df[,"third_incentive_burnout10"], burnout.df[,"third_incentive_burnout11"]))   
              
              names(temp6) <- c("burnout_interpolation_int","burnout_interpolation_dec","third_incentive_burnout0","third_incentive_burnout1", "third_incentive_burnout2", "third_incentive_burnout3", "third_incentive_burnout4", "third_incentive_burnout5", "third_incentive_burnout6", "third_incentive_burnout7", "third_incentive_burnout8", "third_incentive_burnout9", "third_incentive_burnout10", "third_incentive_burnout11")			  
              ...
              test4 <- data.frame(apply(temp4, 1, Burnout_Scurve_gnm))
              names(test4) <- c("incentive_dial_3")
              
              test5 <- data.frame(apply(temp5, 1, Burnout_Scurve_gnm))
              names(test5) <- c("incentive_dial_4")
              
              test6 <- data.frame(apply(temp6, 1, Burnout_Scurve_gnm))
              names(test6) <- c("incentive_dial_5")			  
              ...
              media_effect_3 <- fico_mult.df[,"fico_0"] * sato_mult.df[,"sato_0"] * tpo.df$tpo_dial_0 * purpose.df$purpose_dial_0 * test4[,"incentive_dial_3"]
              media_effect_4 <- fico_mult.df[,"fico_1"] * sato_mult.df[,"sato_1"] * tpo.df$tpo_dial_1 * purpose.df$purpose_dial_1 * test5[,"incentive_dial_4"]
              media_effect_5 <- fico_mult.df[,"fico_2"] * sato_mult.df[,"sato_2"] * tpo.df$tpo_dial_2 * purpose.df$purpose_dial_2 * test6[,"incentive_dial_5"]	
    
              Medial_Effect_0 <- data.frame(cbind(data[,"media_effect_interpolation_GNM_int"], data[,"media_effect_interpolation_GNM_dec"], media_effect_0, media_effect_1, media_effect_2))
              names(Medial_Effect_0)  <- c("media_effect_interpolation_GNM_int","media_effect_interpolation_GNM_dec","media_effect_related_0","media_effect_related_1","media_effect_related_2")
			  
              Medial_Effect_1 <- data.frame(cbind(data[,"media_effect_interpolation_int"], data[,"media_effect_interpolation_dec"], media_effect_3, media_effect_4, media_effect_5))
              names(Medial_Effect_1)  <- c("media_effect_interpolation_int","media_effect_interpolation_dec","media_effect_related_3","media_effect_related_4","media_effect_related_5")
              ...
              Media_Effect_dial_0   <- data.frame(apply(Medial_Effect_0, 1, Media_Effect_Interpolation_gnm))
              Media_Effect_dial_1   <- data.frame(apply(Medial_Effect_1, 1, Media_Effect_Interpolation_gnm))
              Media_Effect_dial_tmp <- cbind(Media_Effect_dial_0, Media_Effect_dial_1)
			  Media_Effect_dial	    <- data.frame(apply(Media_Effect_dial_tmp, 1, max))		  
            ...
            submdl.pred <- submdl.pred * mult.df[, "hpa_annual"] * mult.df[, "incentive"] * mult.df[, "cltv"] * mult.df[, "fico"] *mult.df[, "tax"] *mult.df[, "pct_second_lien"] * mult.df[, "acls"] * wala.df[, "wala_mult"] *
              ...
              wala_list_turnover  <- c("purch_lohpa_wala","purch_hihpa_wala","refi_co_lohpa_wala","refi_co_hihpa_wala","refi_nco_lohpa_wala","refi_nco_hihpa_wala","hmod_lohpa_wala","hmod_hihpa_wala","nhmod_lohpa_wala","nhmod_hihpa_wala","rp_lohpa_wala","rp_hihpa_wala")
              ...
              wala.df$refi_co_wala      <- (1.0 - ppdata$hpa_interpolation) * wala.df$refi_co_lohpa_wala + ppdata$hpa_interpolation * wala.df$refi_co_hihpa_wala
              wala.df$refi_nco_wala     <- (1.0 - ppdata$hpa_interpolation) * wala.df$refi_nco_lohpa_wala + ppdata$hpa_interpolation * wala.df$refi_nco_hihpa_wala
              wala.df$hmod_wala         <- (1.0 - ppdata$hpa_interpolation) * wala.df$hmod_lohpa_wala + ppdata$hpa_interpolation * wala.df$hmod_hihpa_wala
              wala.df$nhmod_wala        <- (1.0 - ppdata$hpa_interpolation) * wala.df$nhmod_lohpa_wala + ppdata$hpa_interpolation * wala.df$nhmod_hihpa_wala
              wala.df$rp_wala           <- (1.0 - ppdata$hpa_interpolation) * wala.df$rp_lohpa_wala + ppdata$hpa_interpolation * wala.df$rp_hihpa_wala
              
              wala.df$wala  <- (wala.df$purch_wala * data$pct_purchase + wala.df$refi_co_wala * data$pct_refi_co + wala.df$refi_nco_wala *data$pct_refi_nco + wala.df$hmod_wala *data$pct_hmod + wala.df$nhmod_wala *data$pct_nhmod + wala.df$rp_wala *data$pct_rp) / 100
              ...
              cout_burnout_list  <- c("purch_incentive_0","purch_incentive_1","purch_incentive_2","purch_incentive_3","refi_co_incentive_0","refi_co_incentive_1","refi_co_incentive_2","refi_co_incentive_3","refi_nco_incentive_0","refi_nco_incentive_1","refi_nco_incentive_2","refi_nco_incentive_3","hmod_incentive_0","hmod_incentive_1","hmod_incentive_2","hmod_incentive_3","nhmod_incentive_0","nhmod_incentive_1","nhmod_incentive_2","nhmod_incentive_3","rp_incentive_0","rp_incentive_1","rp_incentive_2","rp_incentive_3")
			  ...
			  cout_temp1 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"purch_incentive_0"], cout_burnout.df[,"purch_incentive_1"], cout_burnout.df[,"purch_incentive_2"], cout_burnout.df[,"purch_incentive_3"]))  
              
              names(cout_temp1) <- c("wala_interpolation_int","wala_interpolation_dec","purch_incentive_0","purch_incentive_1", "purch_incentive_2", "purch_incentive_3")
              
			  cout_temp2 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"refi_co_incentive_0"], cout_burnout.df[,"refi_co_incentive_1"], cout_burnout.df[,"refi_co_incentive_2"], cout_burnout.df[,"refi_co_incentive_3"]))  
              
              names(cout_temp2) <- c("wala_interpolation_int","wala_interpolation_dec","refi_co_incentive_0","refi_co_incentive_1", "refi_co_incentive_2", "refi_co_incentive_3")
              
			  cout_temp3 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"refi_nco_incentive_0"], cout_burnout.df[,"refi_nco_incentive_1"], cout_burnout.df[,"refi_nco_incentive_2"], cout_burnout.df[,"refi_nco_incentive_3"]))  
              
              names(cout_temp3) <- c("wala_interpolation_int","wala_interpolation_dec","refi_nco_incentive_0","refi_nco_incentive_1", "refi_nco_incentive_2", "refi_nco_incentive_3")
              
			  cout_temp4 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"hmod_incentive_0"], cout_burnout.df[,"hmod_incentive_1"], cout_burnout.df[,"hmod_incentive_2"], cout_burnout.df[,"hmod_incentive_3"]))  
              
              names(cout_temp4) <- c("wala_interpolation_int","wala_interpolation_dec","hmod_incentive_0","hmod_incentive_1", "hmod_incentive_2", "hmod_incentive_3")
              
			  cout_temp5 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"nhmod_incentive_0"], cout_burnout.df[,"nhmod_incentive_1"], cout_burnout.df[,"nhmod_incentive_2"], cout_burnout.df[,"nhmod_incentive_3"]))  
              
              names(cout_temp5) <- c("wala_interpolation_int","wala_interpolation_dec","nhmod_incentive_0","nhmod_incentive_1", "nhmod_incentive_2", "nhmod_incentive_3")
              
			  cout_temp6 <- data.frame(cbind(data[,"wala_interpolation_int"], data[,"wala_interpolation_dec"], cout_burnout.df[,"rp_incentive_0"], cout_burnout.df[,"rp_incentive_1"], cout_burnout.df[,"rp_incentive_2"], cout_burnout.df[,"rp_incentive_3"]))  
              
              names(cout_temp6) <- c("wala_interpolation_int","wala_interpolation_dec","rp_incentive_0","rp_incentive_1", "rp_incentive_2", "rp_incentive_3")
