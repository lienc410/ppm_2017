...
cat("running turn mdl", "\n")        
              ...
              wala_list_turnover  <- c("purch_wala_0","purch_wala_1","refi_co_wala_0","refi_co_wala_1","refi_nco_wala_0","refi_nco_wala_1","hmod_wala_0","hmod_wala_1","nhmod_wala_0","nhmod_wala_1","rp_wala_0","rp_wala_1")
			  ...
			  tover_temp1 <- data.frame(cbind(data[,"hpa_interpolation_int"], data[,"hpa_interpolation_dec"], wala.df[,"purch_wala_0"], wala.df[,"purch_wala_1"]))  
              
              names(tover_temp1) <- c("hpa_interpolation_int","hpa_interpolation_dec","purch_wala_0","purch_wala_1")
              
			  tover_temp2 <- data.frame(cbind(data[,"hpa_interpolation_int"], data[,"hpa_interpolation_dec"], wala.df[,"refi_co_wala_0"], wala.df[,"refi_co_wala_1"]))  
              
              names(tover_temp2) <- c("hpa_interpolation_int","hpa_interpolation_dec","refi_co_wala_0","refi_co_wala_1")
              
			  tover_temp3 <- data.frame(cbind(data[,"hpa_interpolation_int"], data[,"hpa_interpolation_dec"], wala.df[,"refi_nco_wala_0"], wala.df[,"refi_nco_wala_1"]))  
              
              names(tover_temp3) <- c("hpa_interpolation_int","hpa_interpolation_dec","refi_nco_wala_0","refi_nco_wala_1")

			  tover_temp4 <- data.frame(cbind(data[,"hpa_interpolation_int"], data[,"hpa_interpolation_dec"], wala.df[,"hmod_wala_0"], wala.df[,"hmod_wala_1"]))  
              
              names(tover_temp4) <- c("hpa_interpolation_int","hpa_interpolation_dec","hmod_wala_0","hmod_wala_1")

			  tover_temp5 <- data.frame(cbind(data[,"hpa_interpolation_int"], data[,"hpa_interpolation_dec"], wala.df[,"nhmod_wala_0"], wala.df[,"nhmod_wala_1"]))  
              
              names(tover_temp5) <- c("hpa_interpolation_int","hpa_interpolation_dec","nhmod_wala_0","nhmod_wala_1")

			  tover_temp6 <- data.frame(cbind(data[,"hpa_interpolation_int"], data[,"hpa_interpolation_dec"], wala.df[,"rp_wala_0"], wala.df[,"rp_wala_1"]))  
              
              names(tover_temp6) <- c("hpa_interpolation_int","hpa_interpolation_dec","rp_wala_0","rp_wala_1")             
