...
ppdata$curt       <- PredictSubmodel_4_70_interpolation(coll=coll, submodel="curt", submdl.spl=curt.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$pred
...
ppdata$cout                 <- PredictSubmodel_4_70_interpolation(coll=coll, submodel="cout", submdl.spl=cout.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
ppdata$turn                 <- PredictSubmodel_4_70_interpolation(coll=coll, submodel="turn", submdl.spl=turn.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
ppdata$refi                 <- PredictSubmodel_4_70_interpolation(coll=coll, submodel="refi", submdl.spl=refi.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
ppdata$credit_curing        <- PredictSubmodel_4_70_interpolation(coll=coll, submodel="cc", submdl.spl=credcur.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
ppdata$fta            <- PredictSubmodel_4_70_interpolation(coll=coll, submodel="fta", submdl.spl=fta.mdl, data=ppdata, seasadj=FALSE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
# turn_test       <- PredictSubmodel_4_70_interpolation(coll=coll, submodel="turn", submdl.spl=turn.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$mult
# cout_test       <- PredictSubmodel_4_70_interpolation(coll=coll, submodel="cout", submdl.spl=cout.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$mult
# refi_test       <- PredictSubmodel_4_70_interpolation(coll=coll, submodel="refi", submdl.spl=refi.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$mult
# cc_test       <- PredictSubmodel_4_70_interpolation(coll=coll, submodel="cc", submdl.spl=credcur.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$mult
