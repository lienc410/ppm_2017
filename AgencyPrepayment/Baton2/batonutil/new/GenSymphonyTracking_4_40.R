...
# incentive elbow shift for TPO fro refinance submodel
...
ppdata$lomedia_tpo_incentive_adj  <- (ppdata$pct_NonRETAIL * elbow_mult.df$lomedia_nonRetail_elbow + ppdata$pct_BROKER * elbow_mult.df$lomedia_broker_elbow + ppdata$pct_CORRES * elbow_mult.df$lomedia_corres_elbow + ppdata$pct_RETAIL_CashWindow * elbow_mult.df$lomedia_retailCashWindow_elbow + ppdata$pct_RETAIL_NonCashWindow * elbow_mult.df$lomedia_retailNonCashWindow_elbow) / 100

ppdata$himedia_tpo_incentive_adj  <- (ppdata$pct_NonRETAIL * elbow_mult.df$himedia_nonRetail_elbow + ppdata$pct_BROKER * elbow_mult.df$himedia_broker_elbow + ppdata$pct_CORRES * elbow_mult.df$himedia_corres_elbow + ppdata$pct_RETAIL_CashWindow * elbow_mult.df$himedia_retailCashWindow_elbow + ppdata$pct_RETAIL_NonCashWindow * elbow_mult.df$himedia_retailNonCashWindow_elbow) / 100
