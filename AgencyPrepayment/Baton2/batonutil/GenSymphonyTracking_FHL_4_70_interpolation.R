...
names(ppdata)   <- c("loanseqnum","asOf","monthBucket","bal","pct_owner","pct_2nd","pct_inv"
                     ...
                     ,"hpa2yr","cai","media_effect","day_count","wam","hpa_annual","hpa_cum","acls","pct_purchase","pct_second_lien", "refinance_incentive","oltv","pct_preHARP","pct_NY","pct_FGU4","pct_FGU7","NACol")
...
pre_list_turnover  <- c("hpa_interp","hpa_interp_U4","hpa_interp_U7") 
...
ppdata$hpa_interp_U4    <- ppdata$hpa_annual
ppdata$hpa_interp_U7    <- ppdata$hpa_annual
...
ppdata$hpa_interpolation_U4      <-   preparation_tover.df$hpa_interp_U4
ppdata$hpa_interpolation_U7      <-   preparation_tover.df$hpa_interp_U7
...
ppdata$lohpa_wala_U4      <- ppdata$wala
ppdata$lohpa_wala_U7      <- ppdata$wala

ppdata$hihpa_wala         <- ppdata$wala
ppdata$hihpa_wala_U4      <- ppdata$wala
ppdata$hihpa_wala_U7      <- ppdata$wala
