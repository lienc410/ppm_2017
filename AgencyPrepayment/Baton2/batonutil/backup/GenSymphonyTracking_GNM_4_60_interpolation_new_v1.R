...
names(ppdata)   <- c("loanseqnum","asOf","monthBucket","loanType","bal","incentive","refinance_incentive","refinance_incentive_MAX","burnout","wala","wacls","acls","cltv","fico","hasFICOFlag",
...
ppdata$media_effect_interpolation_MAX_int  <- 0
ppdata$media_effect_interpolation_MAX_dec  <- 0
...
ppdata$incentive_MAX_0  <- ppdata$refinance_incentive_MAX + ppdata$incentive_adj_0
ppdata$incentive_MAX_1  <- ppdata$refinance_incentive_MAX + ppdata$incentive_adj_1
ppdata$incentive_MAX_2  <- ppdata$refinance_incentive_MAX + ppdata$incentive_adj_2
...
ppdata$first_incentive_MAX_burnout0  <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout1  <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout2  <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout3  <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout4  <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout5  <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout6  <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout7  <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout8  <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout9  <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout10 <- ppdata$incentive_MAX_0
ppdata$first_incentive_MAX_burnout11 <- ppdata$incentive_MAX_0

ppdata$second_incentive_MAX_burnout0  <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout1  <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout2  <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout3  <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout4  <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout5  <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout6  <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout7  <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout8  <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout9  <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout10 <- ppdata$incentive_MAX_1
ppdata$second_incentive_MAX_burnout11 <- ppdata$incentive_MAX_1

ppdata$third_incentive_MAX_burnout0  <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout1  <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout2  <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout3  <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout4  <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout5  <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout6  <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout7  <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout8  <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout9  <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout10 <- ppdata$incentive_MAX_2
ppdata$third_incentive_MAX_burnout11 <- ppdata$incentive_MAX_2
...
defaultResult       <- data.frame(PredictDflt_2(dfltD0.mdl, dfltD30.mdl, dfltD60.mdl, dfltD90.mdl, dfltCure.mdl, dfltBuyout.mdl, ppdata, kNewModelVersion))
