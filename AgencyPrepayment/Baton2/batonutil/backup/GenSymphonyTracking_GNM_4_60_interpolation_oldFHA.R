...
names(ppdata)   <- c("loanseqnum","asOf","monthBucket","loanType","bal","incentive","refinance_incentive","burnout","wala","wacls","acls","cltv", "fico","hasFICOFlag","hpa_annual","hpa_cum","pct_broker","pct_corres","pct_retail","pct_na","cai","media_effect","pct_purchase","pct_second_lien","wam","oltv","day_count","pct_preHARP","pct_NY","pct_refi_co","pct_refi_nco", "pct_hmod","pct_nhmod","pct_rp","pct_none","monthsSinceIssued","pct_TX","delq_flag","monthsSince","delMonths","reperformingStatus","walaAtStatus","sato","dti","laggedUnemployChangeSinceStatus","cumHpi","buyoutIncentive","servicerBuyoutIndex","ftaIncentive","prepayMonth","NACol")
