...
names(ppdata)   <- c("loanseqnum","asOf","monthBucket","loanType","bal","incentive","refinance_GNM_incentive","refinance_incentive","burnout","wala","wacls","acls","cltv","fico","hasFICOFlag",
...
ppdata$media_effect_GNM_interpolation          <- preparation.df$media_effect
ppdata$media_effect_interpolation_GNM_int      <- floor(preparation.df$media_effect)
ppdata$media_effect_interpolation_GNM_dec      <- ppdata$media_effect_GNM_interpolation - ppdata$media_effect_interpolation_GNM_int
ppdata$media_effect_interpolation_int  <- 0
ppdata$media_effect_interpolation_dec  <- 0
...
ppdata$incentive_GNM_0  <- ppdata$refinance_GNM_incentive + ppdata$incentive_adj_0
ppdata$incentive_GNM_1  <- ppdata$refinance_GNM_incentive + ppdata$incentive_adj_1
ppdata$incentive_GNM_2  <- ppdata$refinance_GNM_incentive + ppdata$incentive_adj_2
...
ppdata$first_incentive_GNM_burnout0  <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout1  <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout2  <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout3  <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout4  <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout5  <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout6  <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout7  <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout8  <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout9  <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout10 <- ppdata$incentive_GNM_0
ppdata$first_incentive_GNM_burnout11 <- ppdata$incentive_GNM_0

ppdata$second_incentive_GNM_burnout0  <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout1  <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout2  <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout3  <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout4  <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout5  <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout6  <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout7  <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout8  <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout9  <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout10 <- ppdata$incentive_GNM_1
ppdata$second_incentive_GNM_burnout11 <- ppdata$incentive_GNM_1

ppdata$third_incentive_GNM_burnout0  <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout1  <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout2  <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout3  <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout4  <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout5  <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout6  <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout7  <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout8  <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout9  <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout10 <- ppdata$incentive_GNM_2
ppdata$third_incentive_GNM_burnout11 <- ppdata$incentive_GNM_2
...
ppdata$refi_co_lohpa_wala            <- ppdata$wala
ppdata$refi_co_hihpa_wala            <- ppdata$wala
ppdata$refi_nco_lohpa_wala           <- ppdata$wala
ppdata$refi_nco_hihpa_wala           <- ppdata$wala
ppdata$hmod_lohpa_wala               <- ppdata$wala
ppdata$hmod_hihpa_wala               <- ppdata$wala
ppdata$nhmod_lohpa_wala              <- ppdata$wala
ppdata$nhmod_hihpa_wala              <- ppdata$wala
ppdata$rp_lohpa_wala                 <- ppdata$wala
ppdata$rp_hihpa_wala                 <- ppdata$wala
...
defaultResult       <- data.frame(PredictDflt(dfltD0.mdl, dfltD30.mdl, dfltD60.mdl, NA, dfltCure.mdl, dfltBuyout.mdl, ppdata, kNewModelVersion))
...
ppdata$fta            <- PredictSubmodel_4_60_interpolation(coll=coll, submodel="fta", submdl.spl=fta.mdl, data=ppdata, seasadj=FALSE, version=kNewModelVersion)$pred * ppdata$bizDatCntAdj
...
# cc_test       <- PredictSubmodel_4_60_interpolation(coll=coll, submodel="cc", submdl.spl=credcur.mdl, data=ppdata, seasadj=TRUE, version=kNewModelVersion)$mult
...
#smm.df.csv    <- data.frame(paste(ppdata$loanseqnum, ppdata$asOf, ppdata$curt, ppdata$dfltall, ppdata$turn, ppdata$cout, ppdata$refi, ppdata$credit_curing, ppdata$fta, ppdata$dfltTransit, ppdata$dfltBuyout, ppdata$modelSMM, names(cc_test), cc_test, "",sep = "|"))
