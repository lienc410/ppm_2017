...
# incentive elbow shift for TPO for refinance submodel
ppdata$lomedia_nonRetail_elbow_wacls     <- ppdata$wacls
ppdata$lomedia_broker_elbow_wacls     <- ppdata$wacls
ppdata$lomedia_corres_elbow_wacls     <- ppdata$wacls
ppdata$lomedia_retailCashWindow_elbow_wacls     <- ppdata$wacls
ppdata$lomedia_retailNonCashWindow_elbow_wacls     <- ppdata$wacls
ppdata$himedia_nonRetail_elbow_wacls     <- ppdata$wacls
ppdata$himedia_broker_elbow_wacls     <- ppdata$wacls
ppdata$himedia_corres_elbow_wacls     <- ppdata$wacls
ppdata$himedia_retailCashWindow_elbow_wacls     <- ppdata$wacls
ppdata$himedia_retailNonCashWindow_elbow_wacls     <- ppdata$wacls

elbow_list_refinance  <- c("lomedia_nonRetail_elbow_wacls", "lomedia_broker_elbow_wacls", "lomedia_corres_elbow_wacls", "lomedia_retailCashWindow_elbow_wacls", "lomedia_retailNonCashWindow_elbow_wacls", "himedia_nonRetail_elbow_wacls", "himedia_broker_elbow_wacls", "himedia_corres_elbow_wacls", "himedia_retailCashWindow_elbow_wacls", "himedia_retailNonCashWindow_elbow_wacls")
...
ppdata$lomedia_tpo_incentive_adj  <- (ppdata$pct_NonRETAIL * elbow_mult.df$lomedia_nonRetail_elbow_wacls + ppdata$pct_BROKER * elbow_mult.df$lomedia_broker_elbow_wacls + ppdata$pct_CORRES * elbow_mult.df$lomedia_corres_elbow_wacls + ppdata$pct_RETAIL_CashWindow * elbow_mult.df$lomedia_retailCashWindow_elbow_wacls + ppdata$pct_RETAIL_NonCashWindow * elbow_mult.df$lomedia_retailNonCashWindow_elbow_wacls) / 100

ppdata$himedia_tpo_incentive_adj  <- (ppdata$pct_NonRETAIL * elbow_mult.df$himedia_nonRetail_elbow_wacls + ppdata$pct_BROKER * elbow_mult.df$himedia_broker_elbow_wacls + ppdata$pct_CORRES * elbow_mult.df$himedia_corres_elbow_wacls + ppdata$pct_RETAIL_CashWindow * elbow_mult.df$himedia_retailCashWindow_elbow_wacls + ppdata$pct_RETAIL_NonCashWindow * elbow_mult.df$himedia_retailNonCashWindow_elbow_wacls) / 100
